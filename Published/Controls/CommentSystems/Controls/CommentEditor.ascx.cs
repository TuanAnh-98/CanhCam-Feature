...
namespace CanhCam.Web.UI
{
    public partial class CommentEditor : UserControl
    {
        ...
        private string notificationTemplateName = "BlogCommentNotificationEmail";
        ...
        private void SendCommentNotificationEmail()
        {
            ...
            string messageTemplate = MessageTemplate.GetMessage(notificationTemplateName);
        ...
        private void LoadSetings()
        {
            ...
            regexEmail.ErrorMessage = Resource.EmailRegexMessage;
