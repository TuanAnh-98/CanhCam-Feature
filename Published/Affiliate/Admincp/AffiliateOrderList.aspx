<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master"
    CodeBehind="AffiliateOrderList.aspx.cs" Inherits="CanhCam.Web.AffiliateUI.AffiliateOrderList" %>
                ...
                <MasterTableView DataKeyNames="AffiliateID" AllowPaging="false" AllowSorting="false">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Tổng số tiền" HeaderStyle-CssClass="tableTBar">
                            <ItemTemplate>
                                <%# CanhCam.Web.ProductUI.ProductHelper.FormatPrice(Convert.ToDecimal(Eval("ProductPrice")), true)%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
