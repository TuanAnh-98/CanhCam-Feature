...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="ddBillingDistrict">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="ddlShippingMethod" />
            ...
            <telerik:AjaxSetting AjaxControlID="ddlShippingOptions">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="litShippingFee" />
                    <telerik:AjaxUpdatedControl ControlID="litOrderTotal" />
                </UpdatedControls>
            ...
            <telerik:AjaxSetting AjaxControlID="btnCalShippingFee">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="litShippingFee" />
                    <telerik:AjaxUpdatedControl ControlID="litOrderTotal" />
                </UpdatedControls>
    ...
    <div class="admin-content">
        ...
        <portal:HeadingPanel ID="heading" runat="server">
            <asp:Button ID="btnSendERP" SkinID="UpdateButton" Text="Gửi ERP" runat="server" Visible="false" />
            <asp:Button ID="btnSendShippingment" SkinID="UpdateButton" Text="Gửi Giao vận" runat="server" Visible="false" />
            ...
            <a runat="server" id="linkCancelButton" href="#" data-fancybox="OrderCancel" data-options='{"parentEl" : "form"}' data-src="#divOrderCancel" class="btn btn-danger btn-delete">
                <asp:Literal runat="server" Text="<%$Resources:ProductResources, CancelButton %>" />
            </a>
            <asp:Button ID="btnDelete" SkinID="DeleteButton" Text="<%$Resources:Resource, DeleteButton %>" runat="server" CausesValidation="false" Visible="false" />
        ...
        <div class="workplace">
            <div id="divtabs" runat="server" class="tabs">
                <ul id="ulTabs" class="nav nav-tabs" runat="server">
                    ...
                    <li role="presentation">
                        <asp:Literal ID="litTabLogs" runat="server" /></li>
                </ul>
                <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="admin-content-bg-white">
                                    <div class="mrb10" runat="server" visible="false">
                                    ...
                                    <telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
                                        <MasterTableView DataKeyNames="Guid,ProductId,AttributeDescription,AttributesXml,Quantity,DiscountAmount" AllowPaging="false" AllowSorting="false">
                                            <Columns>
                                                <telerik:GridTemplateColumn Visible="false" UniqueName="Delete" HeaderStyle-Width="35">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" CommandArgument='<%#Eval("ProductId").ToString()%>'><i class="fa fa-trash"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="<%$Resources:ProductResources, OrderQuantityLabel %>" UniqueName="Quantity">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtQuantity" SkinID="NumericTextBox" Visible="true" Enabled="false"
                                                ...
                                                <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" HeaderText="Coupon" UniqueName="CouponAmount">
                                                    <ItemTemplate>
                                                        <%#CanhCam.Web.ProductUI.ProductHelper.FormatPrice(-Convert.ToDecimal(Eval("CouponAmount")), true)%>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-horizontal">
                                            <div class="settingrow form-group" runat="server" id="divStaff">
                                                <gb:SiteLabel ID="SiteLabel13" runat="server"
                                                    CssClass="settinglabel control-label mb-0 text-left text-strong col-xs-12 col-sm-12 col-md-12 col-lg-3"
                                            ...
                                            <div class="settingrow form-group" runat="server" id="divStaffProcess">
                                                <gb:SiteLabel ID="SiteLabel14" runat="server"
                                                    CssClass="settinglabel control-label mb-0 text-left text-strong col-xs-12 col-sm-12 col-md-12 col-lg-3"
                                                    Text="Nhân viên xử lý đơn hàng" />
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                                                    <div style="position: relative;" class="mrb10">
                                                        <telerik:RadAutoCompleteBox ID="cbStaffProcess"
                                                            TextSettings-SelectionMode="Single" Skin="Simple"
                                                            runat="server" Width="100%" DropDownWidth="250" DropDownHeight="200"
                                                            EmptyMessage="Tìm nhân viên" OnClientEntryAdding="OnClientEntryAddingHandler">
                                                            <WebServiceSettings Method="GetStaff" Path="/Product/AdminCP/OrderEdit.aspx" />
                                                            <ClientDropDownItemTemplate>
                                                    <table cellpadding="0" cellspacing="3" width="100%">
                                            ...
                                            <div class="settingrow form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                                                    <p class="form-control-static mb-0">
                                                        ...
                                                        <asp:Literal runat="server" ID="litERPOrderCode" />
                                                    </p>
                                                </div>
                                            </div>
                                            <%--Order Status--%>
                                            <div class="settingrow form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                                                    <p class="form-control-static mb-0">
                                                        ...
                                                        <asp:Literal runat="server" ID="litOrderCancelInfo" />
                                                    </p>
                                                </div>
                                            </div>
                                            <%--Shipping Method--%>
                                                ...
                                                <div class="settingrow form-group">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                                                        <div class="settingrow form-group row">
                                                            <div class="col-md-6">
                                                                <gb:SiteLabel runat="server" Text="Tổng trọng lượng" CssClass="settinglabel control-label" />
                                                                <asp:TextBox runat="server" ID="txtTotalWeight" CssClass="form-control" />
                                                            </div>
                                                            <div class="col-md-6">
                                                                <gb:SiteLabel runat="server" Text="Tổng chiều dài" CssClass="settinglabel control-label" />
                                                                <asp:TextBox runat="server" ID="txtTotalLength" CssClass="form-control" />
                                                            </div>
                                                            <div class="col-md-6">
                                                                <gb:SiteLabel runat="server" Text="Tổng chiều rộng" CssClass="settinglabel control-label" />
                                                                <asp:TextBox runat="server" ID="txtTotalWidth" CssClass="form-control" />
                                                            </div>
                                                            <div class="col-md-6">
                                                                <gb:SiteLabel runat="server" Text="Tổng chiều cao" CssClass="settinglabel control-label" />
                                                                <asp:TextBox runat="server" ID="txtTotalHeight" CssClass="form-control" />
                                                            </div>
                                                            <div class="col-md-12">
                                                                <asp:Button runat="server" ID="btnCalShippingFee" Text="Tính giá vận chuyển" SkinID="UpdateButton" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="settingrow form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                                                    <asp:DropDownList ID="ddlPaymentStatus" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                                            ...
                                            <%--Created On--%>
                                            <div class="settingrow form-group">
                                                <gb:SiteLabel ID="lblCreatedOn" runat="server" CssClass="settinglabel control-label mb-0 text-left col-xs-12 col-sm-12 col-md-12 col-lg-3" ConfigKey="OrderCreatedOnLabel" ResourceFile="ProductResources" />
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                                                    <p class="form-control-static mb-0">
                                            ...
                                            <div class="settingrow form-group" runat="server" id="divTimeProcessOrder" visible="false">
                                                <gb:SiteLabel ID="SiteLabel7" runat="server" CssClass="settinglabel control-label mb-0 text-left col-xs-12 col-sm-12 col-md-12 col-lg-3"
                                                    Text="Thời gian xử lý đơn hàng" />
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                                                    <p class="form-control-static mb-0">
                                                        <asp:Literal ID="litTimeProcessOrder" runat="server" />
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-horizontal">
                                            ...
                                            <asp:Panel ID="pnlServiceFee" runat="server" Visible="false">
                                                <div class="settingrow form-group">
                                                    <gb:SiteLabel ID="SiteLabel9" runat="server"
                                                        CssClass="settinglabel control-label mb-0 col-xs-12 col-sm-12 col-md-12 col-lg-6"
                                                        Text="Phí dịch vụ " />
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 text-right">
                                                        <p class="form-control-static mb-0">
                                                            <asp:Literal ID="litOrderServiceFee" runat="server" />
                                                        </p>
                                                    </div>
                                                </div>
                                            </asp:Panel>
                                            ...
                                            <asp:Panel ID="pnlRewardPoints" runat="server" Visible="false">
                                                <div class="settingrow form-group">
                                                    <gb:SiteLabel ID="SiteLabel2" runat="server"
                                                        CssClass="settinglabel control-label mb-0 col-xs-12 col-sm-12 col-md-12 col-lg-6"
                                                        ConfigKey="RedeemedRewardPointsLabel" ResourceFile="ProductResources" />
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 text-right">
                                                        <p class="form-control-static mb-0">
                                                            <asp:Literal ID="litRewardPointAmount" runat="server" />
                                                        </p>
                                                        <p class="form-control-static mb-0">
                                                            <asp:Literal ID="litRewardPoint" runat="server" />
                                                        </p>
                                                    </div>
                                                </div>
                                            </asp:Panel>
                                            <asp:Panel ID="pnlVouchers" runat="server" Visible="false">
                                                <div class="settingrow form-group">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <asp:DropDownList ID="ddBillingDistrict" AutoPostBack="true" DataValueField="Guid" DataTextField="Name" runat="server" CssClass="form-control">
                                                        <asp:ListItem Text="<%$Resources:ProductResources, OrderSelectLabel %>" Value=""></asp:ListItem>
                                                    </asp:DropDownList>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tabLogs" runat="server">
                        <telerik:RadGrid ID="gridLogs" SkinID="radGridSkin" runat="server">
                            <MasterTableView DataKeyNames="" AllowSorting="false">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Người dùng">
                                        <ItemTemplate>
                                            <%# GetUserName(Eval("UserName").ToString(),Eval("UserEmail").ToString())%>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="<%$Resources:ProductResources, OrderCreatedDateLabel %>">
                                        <ItemTemplate>
                                            <%# DateTimeHelper.Format(Convert.ToDateTime(Eval("CreatedOn")), timeZone, Resources.ProductResources.OrderCreatedDateFormat, timeOffset)%>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                </Columns>
                            </MasterTableView>
    ...
    <div style="display: none;" id="divOrderCancel">
        <asp:Panel runat="server" ID="pnlOrderCancel" CssClass="frm-order-cancle">
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <div class="form-horizontal">
                        <div class="settingrow form-group">
                            <gb:SiteLabel ID="SiteLabel10" runat="server" CssClass="settinglabel control-label col-sm-4 mb-0"
                                ConfigKey="OrderCancelNoteLabel" ResourceFile="ProductResources" />
                            <div class="col-sm-8">
                                <asp:TextBox runat="server" ID="txtOrderCancelNote" TextMode="MultiLine" />
                            </div>
                        </div>
                        <div class="settingrow form-group">
                            <gb:SiteLabel ID="SiteLabel11" runat="server" CssClass="settinglabel control-label col-sm-4 mb-0"
                                ConfigKey="OrderCancelUserLabel" ResourceFile="ProductResources" />
                            <div class="col-sm-8">
                                <asp:Literal runat="server" ID="litUserCancle" />
                            </div>
                        </div>
                        <div class="settingrow form-group">
                            <gb:SiteLabel ID="SiteLabel12" runat="server" CssClass="settinglabel control-label col-sm-4 mb-0"
                                ConfigKey="OrderCancelDateLabel" ResourceFile="ProductResources" />
                            <div class="col-sm-8">
                                <asp:Literal runat="server" ID="litCancleDate" />
                            </div>
                        </div>
                        <div class="settingrow form-btn">
                            <gb:SiteLabel runat="server" CssClass="settinglabel control-label col-sm-4 mb-0"
                                Text=" " />
                            <div class="col-sm-8">
                                <asp:Button ID="btnCancel" SkinID="DeleteButton" Text="<%$Resources:ProductResources, CancelButton %>" runat="server" CausesValidation="false" />
                            </div>
                        </div>
                    </div>
                </ContentTemplate>
