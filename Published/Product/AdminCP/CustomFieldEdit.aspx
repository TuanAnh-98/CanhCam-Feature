                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade active in" id="tabContent">
                        <div class="form-horizontal">
                            ...
                            <div id="divFieldType" runat="server" class="settingrow form-group">
                            ...
                            <div id="divOptions" runat="server" class="settingrow form-group">
                            ...
                            <div id="divDataType" runat="server" class="settingrow form-group">
                            ...
                            <div id="divFilterType" runat="server" class="settingrow form-group">
                            ...
                            <div id="divIsEnabled" runat="server" class="settingrow form-group">
                            ...
                            <asp:UpdatePanel ID="up" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div id="divDisplayName" runat="server" class="settingrow form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-addon">
                                                <ul class="nav sorter">
                                                    <li>
                                                        <asp:LinkButton ID="btnOptionUp" CssClass="btn btn-default" CommandName="up" runat="server"><i class="fa fa-angle-up"></i></asp:LinkButton></li>
                                                    <li>
                                                        <asp:LinkButton ID="btnOptionDown" CssClass="btn btn-default" CommandName="down" runat="server"><i class="fa fa-angle-down"></i></asp:LinkButton></li>
                                                    <li>
                                                        <asp:LinkButton ID="btnDeleteOption" CssClass="btn btn-default" runat="server"><i class="fa fa-trash"></i></asp:LinkButton></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
