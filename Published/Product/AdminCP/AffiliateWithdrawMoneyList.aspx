<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master"
    CodeBehind="AffiliateWithdrawMoneyList.aspx.cs" Inherits="CanhCam.Web.ProductUI.AffiliateWithdrawMoneyList" %>
    ...
    <div class="admin-content col-md-12">
        ...
        <div class="workplace">
            <telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
                <MasterTableView DataKeyNames="affID" AllowPaging="false" AllowSorting="false">
                    <Columns>
