                ...
                <asp:CreateUserWizard ID="RegisterUser" runat="server" NavigationStyle-HorizontalAlign="Center">
                    <WizardSteps>
                            ...
                            <ContentTemplate>
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <asp:Panel ID="pnlUserName" runat="server" CssClass="settingrow form-group">
                                        <gb:SiteLabel ID="lblLoginName" runat="server" ForControl="UserName" CssClass="settinglabel  "
                                    ...
                                    <div class="settingrow form-group">
                                        <gb:SiteLabel ID="lblRegisterEmail1" runat="server" ForControl="Email" CssClass="settinglabel  "
                                    ...
                                    <asp:Panel ID="divConfirmEmail" runat="server" Visible="false" CssClass="settingrow form-group">
                                        <gb:SiteLabel ID="SiteLabel7" runat="server" ForControl="EmailConfirm" CssClass="settinglabel  "
                                    ...
                                    <div class="settingrow form-group">
                                        <gb:SiteLabel ID="lblRegisterPassword1" runat="server" ForControl="Password" CssClass="settinglabel  "
                                    ...
                                    <div class="settingrow form-group" id="divQuestion" runat="server">
                                        <gb:SiteLabel ID="SiteLabel2" runat="server" ForControl="Question" CssClass="settinglabel  "
                                    ...
                                    <div class="settingrow form-group" id="divAnswer" runat="server">
                                        <gb:SiteLabel ID="SiteLabel1" runat="server" ForControl="Answer" CssClass="settinglabel  "
                                    ...
                                    <asp:Panel ID="pnlSubscribe" CssClass="settingrow form-group reg-subscribe" runat="server" Visible="false">
                                        <div class="col-sm-offset-3   ">
                                            <asp:CheckBox ID="chkSubscribe" runat="server" />
                                            <asp:Label ID="lblNewsletterListHeading" runat="server" CssClass="letterlist" />
                                        </div>
                                    </asp:Panel>
                                    <asp:Panel CssClass="settingrow form-group captcha reg-captcha" ID="divCaptcha" runat="server">
                                        <gb:SiteLabel ID="litCaptcha" runat="server" ForControl="captcha" CssClass="settinglabel  "
                                    ...
                                    <div class="settingrow form-group iagree">
                                        <div class="col-sm-offset-3   ">
									...
									<portal:gbLabel ID="ErrorMessage" runat="server" CssClass="col-sm-offset-3 regerror alert alert-danger" />
                        ...
                        <asp:CompleteWizardStep ID="CompleteWizardStep1" runat="server">
                            <ContentTemplate>
                                <div class="regcomplete leading-snug">
