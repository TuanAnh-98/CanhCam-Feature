...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    <div class="login-box">
        <div class="login-logo">
            <portal:HeadingControl ID="headingControl" Text="<%$Resources:Resource, SignInSendPasswordButton %>" runat="server" />
        </div>
        <div class="card">
            <div class="card-body login-card-body">
                <asp:PasswordRecovery ID="PasswordRecovery1" runat="server">
                    <UserNameTemplate>
                        <p class="login-box-msg"><asp:Label ID="lblEnterUserName" CssClass="settinglabel control-label col-sm-3" runat="server" /></p>
                        <asp:Panel ID="pnlRecover" runat="server" DefaultButton="SubmitButton">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <asp:Button CssClass="btn btn-primary btn-block" ID="SubmitButton" runat="server" CommandName="Submit" ValidationGroup="PasswordRecovery1" />
                                </div>
                            </div>
                        </asp:Panel>
                    </UserNameTemplate>
