...
<asp:Xml ID="xmlGmapTransformer" runat="server"></asp:Xml>
<asp:UpdatePanel ID="upLocator" runat="server">
    <ContentTemplate>
        <div class="wrap-dealer">
            ...
            <div class="form-group dealer-country">
                <asp:Label ID="lblCountry" CssClass="label" Text="<%$Resources:DealerResources, CountryLabel %>" runat="server" />
                <asp:DropDownList ID="ddCountry" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="Guid"
