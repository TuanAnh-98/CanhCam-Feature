			...
			<xsl:if test="Id = 4">
				<div class="vnpay-type-group-wrapper">
					...
					<div class="vnpay-type-group vnpay-type-group-dropdown">
						<div class="vnpay-type-group-title">
						   ...
						   src="https://sandbox.vnpayment.vn/paymentv2/images/bank/vietinbank_logo.png" alt="VIETINBANK" />
								...
								<div class="w-100">
									<label class="select-bank">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/bidv_logo.png"
						   alt="BIDV" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="AGRIBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/agribank_logo.png"
						   alt="AGRIBANK" />
										</div>
									</label>
								</div>
						   ...
						   alt="TECHCOMBANK" />
								...
								<div class="w-100">
									<label class="select-bank" for="MBBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/mbb_logo.png"
						   alt="MBBANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="ACB">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/acb_logo.png"
						   alt="ACB" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="VPBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/vpbank_logo.png"
						   alt="VPBANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="SHB">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/shb_logo.png"
						   alt="SHB" />
										</div>
									</label>
								</div>
						   ...
						   src="https://sandbox.vnpayment.vn/paymentv2/images/bank/dongabank_logo.png" alt="DONGABANK" />
								...
								<div class="w-100">
									<label class="select-bank" for="EXIMBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/eximbank_logo.png"
						   alt="EXIMBANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="TPBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/tpbank_logo.png"
						   alt="TPBANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="NCB">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/ncb_logo.png"
						   alt="NCB" />
										</div>
									</label>
								</div>
						   ...
						   src="https://sandbox.vnpayment.vn/paymentv2/images/bank/oceanbank_logo.png" alt="OJB" />
								...
								<div class="w-100">
									<label class="select-bank" for="MSBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/msbank_logo.png"
						   alt="MSBANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="HDBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/hdbank_logo.png"
						   alt="HDBANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="NAMABANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/namabank_logo.png"
						   alt="NAMABANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="OCB">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/ocb_logo.png"
						   alt="OCB" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="SCB">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/scb_logo.png"
						   alt="SCB" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="IVB">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/ivb_logo.png"
						   alt="IVB" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="ABBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/abbank_logo.png"
						   alt="ABBANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="SEABANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/seabank_logo.png"
						   alt="SEABANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="VIETBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/vietbank_logo.png"
						   alt="VIETBANK" />
										</div>
									</label>
								</div>
						   ...
						   src="https://sandbox.vnpayment.vn/paymentv2/images/bank/vietabank_logo.png" alt="VIETABANK" />
								...
								<div class="w-100">
									<label class="select-bank" for="BACABANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/bacabank_logo.png"
						   alt="BACABANK" />
										</div>
									</label>
								</div>
						   ...
						   alt="BAOVIETBANK" />
								...
								<div class="w-100">
									<label class="select-bank" for="PGBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/pgbank_logo.png"
						   alt="PGBANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="GPBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/gpbank_logo.png"
						   alt="GPBANK" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="UOB">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/uob_logo.png"
						   alt="UOB" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="VRB">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/vrb_logo.png"
						   alt="VRB" />
										</div>
									</label>
								</div>
								...
								<div class="w-100">
									<label class="select-bank" for="VIDBANK">
										...
										<div class="content">
											<img src="https://sandbox.vnpayment.vn/paymentv2/images/bank/vidbank_logo.png"
						   alt="VIDBANK" />
										</div>
									</label>
								</div>
