    ...
    <div class="product-review">
        <div class="medium-rating">
            ...
            <div class="rating-star rating-summary">
                <asp:Literal ID="litRatingPercentage" runat="server"></asp:Literal>
            </div>
                        ...
                        <div class="cmt-item">
                            <div class="item" id='<%#"jid-" + Eval("CommentId") %>'>
                                ...
                                <div class="caption">
                                    ...
                                    <% if (CommentType == NewsCommentType.Rating)
                                        { %>
                                ...
                                <span class="cmlike">
                                    ...
                                    <div class="des">
                                        <%--<%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem,"ContentText").ToString()).Replace("\n", "<br />").Replace("\r\n", "<br />") %>--%>
                                        <%# CanhCam.Web.NewsUI.CommentHelper.FormatCommentText(Eval("ContentText").ToString(), Convert.ToBoolean(Eval("IsModerator")))%>
                                    </div>
                                    ...
                                    <%# NewsPermission.CanDeleteComment ? "<div onclick='journalDelete(this);' class='minidel'></div>" : "" %>
                                </div>
                            </div>
                                ...
                                <asp:Repeater ID="rptChildComments"
                                    ...
                                    <ItemTemplate>
                                        <li class="cmt-area" id='<%#"cmt-" + Eval("CommentId") %>'>
                                            <%# NewsPermission.CanDeleteComment ? "<div class='miniclose'></div>" : "" %>
                                            <i class="iconcom"></i>
                                            <div class="jsummary">
                                                <strong class="name">
                                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem,"FullName").ToString()) %>
