        ...
        <asp:Panel ID="pnlSearch" runat="server" CssClass="headInfo" DefaultButton="btnSearch">
            ...
            <div class="settingrow form-group">
                <div class="input-group-prepend">
                    <asp:Button SkinID="DeleteButton" ID="btnClear" Text="<%$Resources:Resource, UserActivityDeleteOlderThan %>" runat="server" CausesValidation="false" />
                </div>
                <asp:TextBox ID="txtOlderDays" Text="90" MaxLength="4" runat="server" />
                <div class="input-group-append mrt5">
