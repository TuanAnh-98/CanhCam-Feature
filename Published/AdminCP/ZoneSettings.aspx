    ...
    <div class="admin-content col-md-12">
        ...
        <div id="divtabs" class="tabs workplace">
            <ul class="nav nav-tabs">
                <li role="presentation"><a class="active" aria-controls="tabSettings" role="tab" data-toggle="tab" href="#tabSettings">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade active in" id="tabSettings">
                    ...
                    <div id="divCode" runat="server" visible="false" class="settingrow form-group">
                        <gb:SiteLabel ID="lblCode" runat="server" ForControl="txtCode" CssClass="settinglabel control-label col-sm-3"
                            ConfigKey="ZoneSettingsCodeLabel" />
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtCode" MaxLength="50" runat="server" />
                        </div>
                    </div>
