                        ...
                        <div class="form-horizontal">
                            ...
                            <div id="divPassword" runat="server" class="settingrow form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ErrorMessage="Vui lòng nhập Mật khẩu" Visible="false" Display="Dynamic" ControlToValidate="txtPassword"
                                        ValidationGroup="profile"></asp:RequiredFieldValidator>
                                </div>
                            </div>
