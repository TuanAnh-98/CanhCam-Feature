        ...
        <asp:Panel ID="pnlSiteSettings" CssClass="workplace" runat="server">
            <div id="divtabs" class="tabs">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" id="liGeneral" runat="server"><a aria-controls='tabSettings' class="active" role='tab' data-toggle='tab' href="#tabSettings">
                    ...
                    <li id="liCompanyInfoTab" runat="server" visible="false" role="presentation"><a aria-controls='tabCompanyInfo' role='tab' data-toggle='tab' href="#tabCompanyInfo">
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tabSecurity" runat="server">
                        <div id="divSecurityTabs" class="tabs">
                            <ul class="nav nav-tabs" role="tablist">
                                <li id="liGeneralSecurity" runat="server" enableviewstate="false">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tabCompanyInfo" runat="server" visible="false">
                        <div class="form-horizontal">
                            <div class="settingrow form-group">
