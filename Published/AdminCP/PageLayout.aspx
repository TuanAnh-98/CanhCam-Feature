...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    <style>.panelayout .btn{width:40px;display:block;padding-bottom:3px}</style>
    ...
    <div class="admin-content col-md-12">
        ...
        <asp:Panel ID="pnlContent" CssClass="pagelayout" runat="server" Visible="False">
            <asp:UpdatePanel ID="upLayout" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    <div class="row">
                        <div id="divAddContent" runat="server" class="col-sm-6">
                            <div class="card card-outline card-warning">
                                <div class="card-header">
                                    <h3 class="card-title"><gb:SiteLabel ID="lblAddModule" runat="server" ConfigKey="PageLayoutAddModuleLabel" UseLabelTag="false" /></h3>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="card card-outline card-warning">
                                <div class="card-header">
                                    <h3 class="card-title"><gb:SiteLabel ID="lblPageLayoutCopyExistModule" runat="server" ConfigKey="PageLayoutCopyExistModuleLabel" UseLabelTag="false" /></h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-horizontal">
                                        <div class="settingrow form-group">
                    ...
                    <div class="workplace panelayout">
                                            ...
                                            <ul class="nav sorter">
                                                <li>
                                                    <asp:LinkButton ID="btnAlt1MoveUp" runat="server"
                                                        CommandName="up" CommandArgument="altcontent1" SkinID="pageLayoutMoveUp" CssClass="btn btn-default"><i class="fa fa-angle-up"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="btnAlt1MoveDown" runat="server"
                                                        CommandName="down" CommandArgument="altcontent1" SkinID="pageLayoutMoveDown"
                                                        CssClass="btn btn-default"><i class="fa fa-angle-down"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="btnMoveAlt1ToCenter" runat="server"
                                                        CssClass="btn btn-default" SkinID="pageLayoutItemMoveDown"><i class="fa fa-angle-double-down"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="btnEditAlt1" runat="server" CommandName="edit" CommandArgument="lbAltContent1"
                                                        CssClass="btn btn-default" SkinID="pageLayoutEditSettings"><i class="fa fa-cog"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="btnDeleteAlt1" runat="server" CommandName="delete" CommandArgument="lbAltContent1"
                                                        SkinID="pageLayoutDeleteItem" CssClass="btn btn-default"><i class="fa fa-trash"></i></asp:LinkButton>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="row regularpanes">
                            <div class="col-sm-3 offset-sm-1 pane layoutleft">
                                            ...
                                            <ul class="nav sorter">
                                                <li>
                                                    <asp:LinkButton ID="LeftUpBtn" runat="server"
                                                        CommandName="up" CommandArgument="LeftPane" SkinID="pageLayoutMoveUp" CssClass="btn btn-default"><i class="fa fa-angle-up"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="LeftDownBtn" runat="server"
                                                        CommandName="down" CommandArgument="LeftPane" SkinID="pageLayoutMoveDown" CssClass="btn btn-default"><i class="fa fa-angle-down"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="LeftRightBtn" runat="server"
                                                        CommandName="right" SkinID="pageLayoutMoveItemRight" CssClass="btn btn-default"><i class="fa fa-angle-double-right"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="LeftEditBtn" runat="server" CommandName="edit" CommandArgument="LeftPane"
                                                        SkinID="pageLayoutEditSettings" CssClass="btn btn-default"><i class="fa fa-cog"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                            ...
                                            <ul class="nav sorter">
                                                <li>
                                                    <asp:LinkButton ID="ContentUpBtn" runat="server"
                                                        CommandName="up" CommandArgument="ContentPane" SkinID="pageLayoutMoveUp" CssClass="btn btn-default"><i class="fa fa-angle-up"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <asp:LinkButton ID="ContentLeftBtn" runat="server"
                                                        SkinID="pageLayoutMoveItemLeft" CssClass="btn btn-default"><i class="fa fa-angle-double-left"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="ContentRightBtn" runat="server"
                                                        SkinID="pageLayoutMoveItemRight" CssClass="btn btn-default"><i class="fa fa-angle-double-right"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="ContentUpToNextButton" runat="server"
                                                        ...
                                                        CssClass="btn btn-default"><i class="fa fa-angle-double-up"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="ContentDownToNextButton" runat="server"
                                                        ...
                                                        CssClass="btn btn-default"><i class="fa fa-angle-double-down"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                            ...
                                            <ul class="nav sorter">
                                                <li>
                                                    <asp:LinkButton ID="RightUpBtn" runat="server"
                                                        CommandName="up" CommandArgument="RightPane" SkinID="pageLayoutMoveUp" CssClass="btn btn-default"><i class="fa fa-angle-up"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <asp:LinkButton ID="RightDownBtn" runat="server"
                                                        CommandName="down" CommandArgument="RightPane" SkinID="pageLayoutMoveDown" CssClass="btn btn-default"><i class="fa fa-angle-down"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                            ...
                                            <ul class="nav sorter">
                                                ...
                                                <li>
                                                    <asp:LinkButton ID="btnAlt2MoveUp" runat="server"
                                                        CommandName="up" CommandArgument="AltContent2" SkinID="pageLayoutMoveUp" CssClass="btn btn-default"><i class="fa fa-angle-up"></i></asp:LinkButton>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <asp:LinkButton ID="btnMoveAlt2ToCenter" runat="server"
                                                        SkinID="pageLayoutMoveItemUp" CssClass="btn btn-default"><i class="fa fa-angle-double-up"></i></asp:LinkButton>
                                                </li>
                                                <li>
