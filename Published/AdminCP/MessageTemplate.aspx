        ...
        <asp:UpdatePanel ID="upPanel" runat="server">
            <ContentTemplate>
                ...
                <div class="workplace">
                    <div class="row">
                        <div class="col-sm-4">
                            <asp:ListBox ID="lbTemplates" Width="100%" Height="600" AutoPostBack="true" runat="server"
                        ...
                        <div class="col-sm-8">
                            <div class="form-horizontal">
                                ...
                                <gb:SiteLabel ID="lblContent" runat="server" ForControl="edContentText" CssClass="settinglabel control-label" ConfigKey="MessageTemplateContentLabel" />
                                <div class="settingrow form-group">
