        ...
        <asp:UpdatePanel ID="upPanel" runat="server">
            <ContentTemplate>
                ...
                <div class="workplace">
                    <div class="row">
                        <div class="col-md-4">
                            <asp:ListBox ID="lbTemplates" Width="100%" Height="977" AutoPostBack="true" runat="server"
                            ...
                            <div class="form-horizontal">
                                ...
                                <asp:UpdatePanel ID="up" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <gb:SiteLabel ID="lblBody" runat="server" CssClass="settinglabel control-label" ConfigKey="EmailTemplateBody" />
                                        <div class="settingrow form-group">
