    ...
    <div class="admin-content col-md-12">
        ...
        <div class="workplace form-horizontal">
            ...
            <div id="divStartDate" runat="server" class="settingrow form-group newsedit-published newsedit-startdate">
                <gb:SiteLabel ID="lblStartDate" runat="server" ConfigKey="StartDate"
                    ResourceFile="BannerResources" CssClass="settinglabel control-label col-sm-3" />
                <div class="col-sm-9">
            ...
            <div id="divEndDate" runat="server" class="settingrow form-group newsedit-published newsedit-enddate">
                <gb:SiteLabel ID="lblEndDate" runat="server" ConfigKey="EndDate" ResourceFile="BannerResources"
