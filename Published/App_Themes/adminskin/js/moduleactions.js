...
(function () {
    ...
    function SetupActionMenu() {
        ...
        for (var i = 0; i < modules.length; i++) {
            var menuActionSelector = modules[i].querySelector(opts.menuActionSelector);
            if (menuActionSelector != null)
                SetupActionMenuItem(modules[i], menuActionSelector);
        }
    }

    function SetupActionMenuItem($module, $menuActionSelector) {
        ...
        $menuActionSelector.style.opacity = opts.defaultOpacity;
