...
<head id="Head1" runat="server">
    ...
    <link href='/ClientScript/jqueryFileTree/jqueryFileTree.css' type='text/css' rel='stylesheet' media='screen' />
</head>
<body class="dialogpage filedialog">
    ...
    <div id="filewrapper" style="padding:10px">
        ...
        <script src="/ClientScript/jqueryFileTree/jqueryFileTree.js" type="text/javascript"></script>
    </form>
</body>
</html>
