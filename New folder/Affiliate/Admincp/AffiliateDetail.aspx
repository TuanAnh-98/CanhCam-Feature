<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master"
    CodeBehind="AffiliateDetail.aspx.cs" Inherits="CanhCam.Web.AffiliateUI.AffiliateDetail" %>
        ...
        <div class="workplace">
            <div>
                <div class="settingrow form-group">
                    <gb:SiteLabel ID="lblBillingEmail" runat="server" CssClass="settinglabel control-label col-sm-3" Text="Tổng số dư hiện tại: " />
                ...
                <div class="settingrow form-group">
                    <gb:SiteLabel ID="Sitelabel1" runat="server" CssClass="settinglabel control-label col-sm-3" Text="Tổng số tiền đã thanh toán: " />
                    <div class="col-sm-9">
                ...
                <div class="settingrow form-group">
                    <gb:SiteLabel ID="Sitelabel3" runat="server" CssClass="settinglabel control-label col-sm-3" Text="Tổng số đơn hàng:  " />
                    <div class="col-sm-9">
