...
namespace CanhCam.Business
{
    ...
    public class AffiliateProduct : IIndexableContent
    {
        ...
        public AffiliateProduct(int siteId, int productId)
        {
            this.GetProduct(siteId, productId, -1);
        }

        public AffiliateProduct(int siteId, int productId, int languageId)
        {
        ...
        {
            PopulateProduct(this, DBAffiliateProduct.GetOne(siteId, productId, languageId));
        }

        public static void PopulateProduct(AffiliateProduct product, IDataReader reader)
        {
            try
            {
                if (reader.Read())
        ...
        private bool Create()
        {
            ...
            newID = DBAffiliateProduct.Create(
                this.siteID,
                this.zoneID,
                this.title,
                this.subTitle,
        ...
        private bool Update()
        {
            ...
            bool result = DBAffiliateProduct.Update(
                this.productID,
                this.siteID,
                this.zoneID,
                this.title,
        ...
        public bool Delete()
        {
            bool result = DBAffiliateProduct.Delete(this.productID);
        ...
        {
            bool result = DBAffiliateProduct.UpdateState(this.productID, this.StateId, this.approvedUtc, this.approvedUserGuid, this.approvedBy, this.rejectedNotes);
        ...
        {
            bool result = DBAffiliateProduct.UpdateStockQuantity(this.productID, this.stockQuantity);
            return result;
        }

        public bool SaveDeleted()
        {
            bool result = DBAffiliateProduct.UpdateDeleted(this.productID, this.isDeleted);
        ...
        {
            using (IDataReader reader = DBAffiliateProduct.GetNextPreviousProduct(this.productID, this.zoneID, languageId))
            {
                if (reader.Read())
                {
        ...
        public static AffiliateProduct GetOneByZone(int zoneId, int languageId)
        {
            AffiliateProduct news = new AffiliateProduct();
            PopulateProduct(news, DBAffiliateProduct.GetOne(zoneId, DateTime.UtcNow, languageId));
        ...
        {
            return DBAffiliateProduct.DeleteBySite(siteId);
        }

        public static List<AffiliateProduct> LoadListFromReader(IDataReader reader, bool loadImage = true)
        {
            List<AffiliateProduct> productList = new List<AffiliateProduct>();
            try
            {
                while (reader.Read())
                {
        ...
        public static int GetCountAdv(
            ...
            string stateIds = null)
        {
            return DBAffiliateProduct.GetCountAdv(siteId, zoneId, zoneIds, publishStatus, languageId, parentId, manufactureId, productType, priceMin, priceMax, position, showOption, propertyCondition, productIds, keyword, searchCode, searchProductZone, stateIds);
        }

        public static List<AffiliateProduct> GetPageAdv(
            int pageNumber = 1,
            int pageSize = 32767,
            int siteId = -1,
            int zoneId = -1,
            ...
            int orderBy = (int)ProductSortingEnum.Position)
        {
            return LoadListFromReader(DBAffiliateProduct.GetPageAdv(pageNumber, pageSize, siteId, zoneId, zoneIds, publishStatus, languageId, parentId, manufactureId, productType, priceMin, priceMax, position, showOption, propertyCondition, productIds, keyword, searchCode, searchProductZone, stateIds, discountId, orderBy));
        }

        public static List<AffiliateProduct> GetTopAdv(
            int top = 1,
            int siteId = -1,
            int zoneId = -1,
            string zoneIds = null,
            ...
            int orderBy = (int)ProductSortingEnum.Position)
        {
            return LoadListFromReader(DBAffiliateProduct.GetTopAdv(top, siteId, zoneId, zoneIds, publishStatus, languageId, parentId, manufactureId, productType, priceMin, priceMax, position, showOption, propertyCondition, productIds, keyword, searchCode, searchProductZone, stateIds, orderBy));
        }
        ...
        public static List<AffiliateProduct> GetRelatedProducts(
            int siteId,
            Guid siteGuid,
            Guid productGuid,
            ...
            int languageId = -1)
        {
            return LoadListFromReader(DBAffiliateProduct.GetRelatedProducts(siteId, siteGuid, productGuid, showHidden, twoWayRelated, languageId));
        }
        ...
        public static List<AffiliateProduct> GetByShoppingCart(
           int siteId,
           Guid cartGuid,
           ShoppingCartTypeEnum cartType,
           int languageId = -1)
        {
            return LoadListFromReader(DBAffiliateProduct.GetByShoppingCart(siteId, cartGuid, (int)cartType, languageId));
        }

        public static List<AffiliateProduct> GetByTag(
           int siteId,
           int tagId,
           int publishStatus = -1,
           int languageId = -1)
        {
            return LoadListFromReader(DBAffiliateProduct.GetByTag(siteId, tagId, publishStatus, languageId));
        }

        public static List<AffiliateProduct> GetByGuids(
           int siteId,
           string productGuids,
           int publishStatus = -1,
           int languageId = -1)
        {
            return LoadListFromReader(DBAffiliateProduct.GetByGuids(siteId, productGuids, publishStatus, languageId));
        }

        public static List<AffiliateProduct> GetByOrder(
            int siteId,
            int orderId,
            int languageId = -1)
        {
            return LoadListFromReader(DBAffiliateProduct.GetByOrder(siteId, orderId, languageId));
        }

        public static IDataReader GetProductForSiteMap(int siteId, int languageId)
        {
            return DBAffiliateProduct.GetProductForSiteMap(siteId, languageId);
        }

        public static bool IncrementViewCount(int productId)
        {
            return DBAffiliateProduct.IncrementViewCount(productId);
        }

        public static bool UpdateZone(int productId, int zoneId)
        {
            return DBAffiliateProduct.UpdateZone(productId, zoneId);
        }

        public static bool UpdateCommentCount(int productId, int commentCount)
        {
            return DBAffiliateProduct.UpdateCommentCount(productId, commentCount);
        }

        public static AffiliateProduct GetByCode(int siteId, string productCode)
        {
            var lst = LoadListFromReader(DBAffiliateProduct.GetByCode(siteId, productCode), false);
            if (lst.Count > 0)
                return lst[0];
        ...
        public static List<int> GetZoneByKeyword(
         ...
         string keyword)
        {
            var reader = DBAffiliateProduct.GetZoneByKeyword(siteId, keyword);
        ...
        {
            return DBAffiliateProduct.UpdateCommentStats(productId);
        }

        public static bool UpdateInventory(int productId)
        {
            return DBAffiliateProduct.UpdateInventory(productId);
        }
        ...
        public static bool ExistsChild(
            int productID)
        {
            IDataReader reader = DBAffiliateProduct.ExistsChild(productID);
