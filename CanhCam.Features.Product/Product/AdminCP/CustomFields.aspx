...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <div class="admin-content col-md-12">
        <portal:HeadingPanel ID="heading" runat="server">
            ...
            <asp:Button SkinID="InsertButton" ID="btnFix" Text="Fix" runat="server"  OnClick="btnFix_Click" />
            ...
            <telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
                <MasterTableView DataKeyNames="CustomFieldId" AllowPaging="false" AllowSorting="false">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="<%$Resources:ProductResources, CustomFieldDisplayNameLabel %>">
                            <ItemTemplate>
                                <%# Eval("DisplayName")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
