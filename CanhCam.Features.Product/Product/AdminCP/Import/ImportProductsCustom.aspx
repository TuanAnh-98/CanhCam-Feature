<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master"
    CodeBehind="ImportProductsCustom.aspx.cs" Inherits="CanhCam.Web.ProductUI.ImportProductsCustomPage" %>
...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <div class="admin-content col-md-12">
        <portal:HeadingPanel ID="heading" runat="server">
            <asp:HyperLink runat="server" SkinID="UpdateButton" Text="File mẫu" NavigateUrl="/data/sites/1/media/importproducts-update.xls" />
            </portal:HeadingPanel>
            ...
            <ContentTemplate> 
                ...
                <div class="workplace">
                    <telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
                        <MasterTableView DataKeyNames="ItemNo,Barcode,Introduce,Details,Catalogue,Description,Images,Catalog,OtherCatalog,Manufacturer,BuyWithItemNos,Video,Published,DisplayOrder,EnableBuyButton,StartDate,ShowOptions,Weight" AutoGenerateColumns="true" AllowSorting="false" AllowPaging="false">
                            <Columns>
                            </Columns>
                        </MasterTableView>
                    </telerik:RadGrid> 
