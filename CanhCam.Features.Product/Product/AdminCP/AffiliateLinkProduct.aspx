<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master"
    CodeBehind="AffiliateLinkProduct.aspx.cs" Inherits="CanhCam.Web.ProductUI.AffiliateLinkProduct" %>
                ...
                <MasterTableView DataKeyNames="productID" AllowPaging="false" AllowSorting="false">
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Sản phẩm" HeaderStyle-CssClass="tableTBar">
                            <ItemTemplate>
                                <a class="nhanvien-img" href="/Data/SiteImages/imagePhongBan/<%# Eval("BarCode")%>">
                                    <img width="100" height="100" src="/Data/SiteImages/imagePhongBan/<%# Eval("BarCode")%>" class="CalloutRightPhoto" />
                                </a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Liên kết (Url)" HeaderStyle-CssClass="tableTBar">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtUrl" Text='<%# SiteRoot + "/san-pham"  +  Eval("Url").ToString().Replace("~","") + "?affid=" +  SiteUtils.GetCurrentSiteUser().UserId%>' ReadOnly="true" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
