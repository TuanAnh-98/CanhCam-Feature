...
namespace CanhCam.Web.ProductUI
{
    public partial class ProductSpecialPage : CmsNonBasePage
    {
        ...
        private void grid2_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            ...
            int iCount = Product.GetCountAdv(siteId: siteSettings.SiteId, zoneIds: ListZoneId, position: position, keyword: txtTitle.Text.Trim());
            ...
            grid2.DataSource = Product.GetPageAdv(pageNumber: startRowIndex, pageSize: maximumRows, siteId: siteSettings.SiteId, zoneIds: ListZoneId, position: position, keyword: txtTitle.Text.Trim());
        }
