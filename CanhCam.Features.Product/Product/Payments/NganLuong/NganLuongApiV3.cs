...
{
    public class NganLuongApiV3
    {

        public static string BASE_URL = ConfigHelper.GetStringProperty("Alepay.UrlNganLuongCheckOut", "https://sandbox.nganluong.vn:8088/nl30/checkout.api.nganluong.post.php");
        ...
        public ResponseInfo GetUrlCheckout(RequestInfo requestContent, string payment_method = "NL")
        {
            ...
            {
                Checkout_url = root.Item(4).InnerText,
                Description = root.Item(2).InnerText,
                Error_code = root.Item(0).InnerText,
                Token = root.Item(1).InnerText
            };
        ...
        public ResponseCheckOrder GetTransactionDetail(RequestCheckOrder info)
        {
            ...
            {
                errorCode = root.Item(0).InnerText,
                token = root.Item(1).InnerText,
                description = root.Item(2).InnerText,
                transactionStatus = root.Item(3).InnerText,
                //objResult.receiver_email = root.Item(4).InnerText; //receiver_email
                order_code = root.Item(5).InnerText,
                paymentAmount = root.Item(6).InnerText, //total_amount
                ...
                payerName = root.Item(16).InnerText, //buyer_fullname
                payerEmail = root.Item(17).InnerText, //buyer_email
                payerMobile = root.Item(18).InnerText, //buyer_mobile
                ...
                transactionId = root.Item(21).InnerText
            };
        ...
        private static String HttpPost(string postData)
        {
            ...
            // Prepare web request...
            HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create(BASE_URL);
