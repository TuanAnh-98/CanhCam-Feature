...
namespace CanhCam.Web.ProductUI
{
    ...
    public partial class NganLuongResult : CmsInitBasePage
    {

        private static readonly ILog log = LogManager.GetLogger(typeof(NganLuongResult));
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                order = NganLuongHelper.ProcessCallbackData();
                if (order == null)
                {
                    SiteUtils.RedirectToHomepage();
                    return;
