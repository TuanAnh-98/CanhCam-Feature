...
namespace CanhCam.Web.ProductUI
{
    public class VnPayLibrary
    {
        ...
        public string CreateRequestUrl(string baseUrl, string vnp_HashSecret)
        {
            ...
            if (VNPAYHelper.SecureHashType.ToLower() == "md5")
                vnp_SecureHash = Utils.Md5(vnp_HashSecret + rawData);
            else if (VNPAYHelper.SecureHashType.ToLower() == "sha256")
                vnp_SecureHash = Utils.Sha256(vnp_HashSecret + rawData);
        ...
        public bool ValidateSignature(string inputHash)
        {
            ...
            string myChecksum = string.Empty;
            if (VNPAYHelper.SecureHashType.ToLower() == "md5")
                myChecksum = Utils.Md5(VNPAYHelper.HashSecret + rspRaw);
            else if (VNPAYHelper.SecureHashType.ToLower() == "sha256")
                myChecksum = Utils.Sha256(VNPAYHelper.HashSecret + rspRaw);
